...
Additionally, we can save millions from department IT spending on the design and code of web sites and mobile apps with the Chicago Design System ([design.chicago.gov](http://design.chicago.gov)), based on [the federal United States Web Design System standards](https://18f.gsa.gov/2019/05/21/centralization-gone-right-a-case-study-on-uswds/). The US Digital Service, who makes the USWDS, estimates a savings of $100,000 on IT project where the system is used. We have dozens of websites today, which is the same use case [driving federal adoption](https://components.designsystem.digital.gov/docs/who_is_using_uswds.html).
